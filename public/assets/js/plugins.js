        ...
        function r(t, n) {
            if (t)
                if (t.resizedAttached) t.resizedAttached.add(n);
                    ...
                    }, t.resizedAttached.add(n), t.resizeSensor = document.createElement("div"), t.resizeSensor.dir = "ltr", t.resizeSensor.className = "resize-sensor";
                    ...
                    "absolute" !== d && "relative" !== d && "fixed" !== d && (t.style.position = "relative");
                    var c, f, h = t.resizeSensor.childNodes[0],
                        a = h.childNodes[0],
                        ...
                        g = function() {
                            if (z) {
                                if (0 === t.offsetWidth && 0 === t.offsetHeight) return void(w || (w = e(function() {
                                    w = 0, g()
                                })));
                                z = !1
                            }
                            var i, n;
                            i = t.offsetWidth, n = t.offsetHeight, a.style.width = i + 10 + "px", a.style.height = n + 10 + "px", h.scrollLeft = i + 10, h.scrollTop = n + 10, l.scrollLeft = i + 10, l.scrollTop = n + 10
                        };
                    t.resizeSensor.resetSensor = g;
                    var y = function() {
                            f = 0, c && (v = u.width, p = u.height, t.resizedAttached && t.resizedAttached.call(u))
                        },
                        m = function() {
                            u = i(t), (c = u.width !== v || u.height !== p) && !f && (f = e(y)), g()
                        },
                        S = function(e, t, i) {
